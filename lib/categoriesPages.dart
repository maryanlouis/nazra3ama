...
class CatPage  extends StatefulWidget {
  CatPage({this.cat_id, this.cat_title});
  final int cat_id;
  final String cat_title;
  /*final FirebaseApp app;
  final FirebaseDatabase database;*/
  @override
  _CatPage  createState() => _CatPage (cat_id: cat_id, cat_title: cat_title);

}


class _CatPage extends State<CatPage>  {
  _CatPage({this.cat_id, this.cat_title});
  final int cat_id;
  final String cat_title;
  /*final FirebaseApp app;
  final FirebaseDatabase database;*/
              ...
              new Expanded(
                child: new ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                      if(fbDatabase.allVedios[index].vedio_category != cat_id){return new Container();}
                      else {
                        return new Card(
                          child: new Container(
                            child: new Center(
                              ...
                              // Stretch the cards in horizontal axis
                                ...
                                children: <Widget>[
                                if(fbDatabase.allVedios[index].vedio_category == cat_id)
                                  GestureDetector(
                                    onTap: ( ) =>
                                        Navigator.push(
